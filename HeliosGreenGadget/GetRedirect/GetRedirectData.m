...
@implementation GetRedirectData
	...
	- (id) init
	{
		if(self = [super init])
		{
            ...
            NSString *url = [d.defaults stringForKey:@"server_url"];
            url =[url stringByReplacingOccurrencesOfString:@"/data.asmx" withString:@""];
			self.serviceUrl = [url stringByAppendingString: @"/data.asmx"];
